              ...
              <transition name="slide">
                ...
                >
                  <li>
                    <a
                      href="/contact"
                      class="relative inline-block pb-2 max-[360px]:pb-1 text-xl max-[360px]:text-lg font-medium leading-tight group"
                    >
                      Connect with us
                      <span
                        class="absolute left-0 -bottom-0.5 w-0 h-[2px] bg-yellow-400 transition-all duration-300 group-hover:w-full"
                  ...
                  <li>
                    <button
                      ...
                      class="relative inline-block pb-2 max-[360px]:pb-1 text-xl max-[360px]:text-lg font-medium leading-tight text-left cursor-pointer group"
                    >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  class="flex flex-col items-center gap-2 max-[360px]:gap-1 text-center sm:items-end"
                >
                  <span class="sm:whitespace-nowrap"
                    ...
                    ></span
                  >
                  <span class="sm:hidden">All rights reserved.</span>
                  <a
