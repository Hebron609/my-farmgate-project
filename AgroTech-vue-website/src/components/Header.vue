...
/>
        ...
        <div class="flex items-start gap-4 sm:gap-6">
          ...
          <div class="relative flex items-center">
            ...
            >
              <font-awesome-icon :icon="['fas', 'search']" class="text-lg text-white" />
            </button>
...
<transition name="slide">
  ...
  >
    <font-awesome-icon :icon="['fas', 'search']" class="mr-2 text-sm text-white/90" />
    <input
      v-model="searchQuery"
      type="text"
  ...
  >
    ...
    <div class="relative flex flex-col lg:flex-row lg:justify-between p-12 max-w-[1820px] mx-auto 
      ...
      <div class="flex-1 mt-20">
        ...
        <ul class="space-y-5">
          <li>
            <a href="/index.html" class="relative pb-2 text-xl font-medium group">
              Home  
      ...
      <div class="flex-1 mt-20">
        ...
        <ul class="space-y-5">
          <li>
            <a href="/about.html" class="relative pb-2 text-xl font-medium group">
              Our Story
              <span class="absolute left-0 -bottom-0.5 w-0 h-[2px] bg-yellow-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </li>
          <li>
            <a href="/team.html" class="relative pb-2 text-xl font-medium group">
              Team
              <span class="absolute left-0 -bottom-0.5 w-0 h-[2px] bg-yellow-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </li>
      ...
      <div class="flex-1 mt-20">
        ...
        <ul class="space-y-5">
          <li>
            <a href="/solutions.html" class="relative pb-2 text-xl font-medium group">
              Our Services
              <span class="absolute left-0 -bottom-0.5 w-0 h-[2px] bg-yellow-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </li>
      ...
      <!-- Contact -->
<div class="flex-1 mt-20">
  <h3 class="mb-6 text-2xl font-semibold text-yellow-400">Connect with us</h3>
    ...
    <g transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
      <g clip-path="url(#clipPath2426)">
        <g transform="translate(378.6821,256.8721)">
          <path d="M 0,0 118.318,-75.157 V -237.29 L 0,-162.133 l -123.64,-77.321 -121.724,77.321 -118.318,-75.157 V -75.157 L -245.364,0"
            stroke="currentColor" stroke-width="30" fill="none"/>
        </g>
        <g transform="translate(256,494.582)">
          <path d="m 0,0 c 82.873,0 150.055,-67.183 150.055,-150.056 0,-69.816 -47.681,-128.492 -112.256,-145.25 L 0,-370.906 l -37.801,75.6 c -64.573,16.759 -112.255,75.435 -112.255,145.25 C -150.056,-67.183 -82.874,0 0,0 Z"
            stroke="currentColor" stroke-width="30" fill="none"/>
        </g>
        <g transform="translate(256,309.8984)">
          <path d="M 0,0 C 19.073,0 34.628,15.556 34.628,34.628 34.628,53.701 19.073,69.257 0,69.257 -19.073,69.257 -34.628,53.701 -34.628,34.628 -34.628,15.556 -19.073,0 0,0 Z"
            stroke="currentColor" stroke-width="30" fill="none"/>
        </g>
      </g>
    </g>
...
<div class="flex items-start gap-2 mb-4">
  ...
  <svg
    ...
    fill="currentColor"
  >
    <path d="M496.516,169.574c-0.458-0.458-0.944-0.885-1.457-1.279c-2.223-1.711-21.537-16.577-48.082-36.865V49.055
    ...
    <path d="M256,258.03c-25.913,0-46.994,21.081-46.994,46.994s21.081,46.994,46.994,46.994s46.994-21.082,46.994-46.994
...
<div class="flex items-start gap-2 mb-4">
  ...
  <svg
    ...
    fill="currentColor"
  >
    <path d="m1554 1053h-889c-11 0-20-9-20-20v-433c0-132-108-240-241-240-26 0-26-40 0-40h803c202 0 367 164 367 366v347c0 11-9 20-20 20zm-869-40h849v-327c0-180-147-326-327-326h-658c82 49 136 138 136 240z"/>
    <path d="m665 631h-521c-21 0-20-20-20-31 0-155 126-280 280-280 155 0 281 125 281 280 0 11 1 31-20 31zm-501-40h481c-5-128-111-231-241-231-129 0-235 103-240 231z"/>
    <path d="m1687 1184h-1543c-11 0-20-9-20-20v-131c0-11 9-20 20-20h1543c11 0 20 9 20 20v131c0 11-9 20-20 20zm-1523-40h1503v-91h-1503z"/>
    <path d="m665 1184c-11 0-20-9-20-20v-131c0-27 40-26 40 0v131c0 11-9 20-20 20z"/>
    <path d="m1277 1652h-174c-11 0-20-9-20-20v-468c0-11 9-20 20-20h174c11 0 20 9 20 20v468c0 11-9 20-20 20zm-154-40h134v-428h-134z"/>
    <path d="m665 1053h-645c-11 0-20-9-20-20v-422c0-11 9-20 20-20h645c11 0 20 9 20 20v422c0 11-9 20-20 20zm-625-40h605v-382h-605z"/>
    <path d="m378 898c-4 0-8-1-12-4l-358-267c-15-11-7-36 12-36h645c28 0 20 39 20 73 0 6-3 12-8 16l-287 214c-4 3-8 4-12 4zm-298-267 298 222 267-199v-23z"/>
    <path d="m1399 1652h-417c-27 0-27-40 0-40h417c26 0 26 40 0 40z"/>
    <path d="m1554 941h-889c-26 0-26-40 0-40h889c26 0 26 40 0 40z"/>
    <path d="m1122 461c-11 0-20-9-20-20v-366c0-27 40-27 40 0v366c0 12-9 20-20 20z"/>
    <path d="m1342 270h-220c-11 0-20-9-20-20v-175c0-11 9-20 20-20h220c11 0 20 9 20 20v175c0 11-9 20-20 20zm-200-40h180v-135h-180z"/>
    <path d="m1122 605c-50 0-92-41-92-92 0-50 42-92 92-92 121 0 121 184 0 184zm0-144c-68 0-68 104 0 104 69 0 69-104 0-104z"/>
  </svg>
  ...
  >
    <g width="100%" height="100%" transform="matrix(1,0,0,1,0,0)">
      <g fill="currentColor">
        ...
        <path d="m19.6 28.5c0-.1-.1-.2-.1-.3-.1-.1-.1-.2-.2-.2-.3-.4-.9-.5-1.3-.4-.1 0-.2 0-.3.1-.1 0-.2.1-.3.1s-.2.1-.2.2c-.1.1-.1.1-.2.2 0 .1-.1 .2-.1 .3s-.1 .2-.1 .3v.3c0 .2 0 .4.1 .6s.2 .3.3 .5c.3 .3.7 .4 1.1 .4s.8-.2 1.1-.4c.1-.1.2-.3.3-.5s.1-.4.1-.6c0-.1 0-.2 0-.3-.1-.1-.2-.2-.2-.3z"/>
        <path d="m25.4 28.5c0-.1-.1-.2-.1-.3s-.1-.2-.2-.2c-.4-.4-.9-.5-1.4-.4-.1 0-.2 0-.3 .1-.1 0-.2 .1-.3 .1s-.2 .1-.2 .2c-.1 .1-.1 .1-.2 .2 0 .1-.1 .2-.1 .3s-.1 .2-.1 .3v.3c0 .2 0 .4.1 .6s.2 .3.3 .5c.3 .3.7 .4 1.1 .4s.8-.2 1.1-.4c.1-.1.2-.3.3-.5s.1-.4.1-.6c0-.1 0-.2 0-.3-.1-.1-.1-.2-.1-.3z"/>
        <path d="m29.5 27.6c-.1 0-.2 0-.3 .1-.1 0-.2 .1-.3 .1s-.2 .1-.2 .2c-.3 .3-.4 .7-.4 1.1 0 .2 0 .4.1 .6s.2 .3.3 .5c.3 .3.7 .4 1.1 .4.2 0 .4 0 .6-.1s.3-.2.5-.3c.1-.1.3-.3.3-.5.1-.2.1-.4.1-.6 0-.4-.2-.8-.4-1.1-.1-.1-.1-.1-.2-.2s-.2-.1-.3-.1-.2-.1-.3-.1c-.2-.1-.4-.1-.6 0z"/>
        <path d="m19.6 33.8c0-.1-.1-.2-.1-.3-.1-.1-.1-.2-.2-.2-.3-.3-.9-.5-1.3-.4-.1 0-.2 .1-.3 .1s-.2 .1-.3 .1-.2 .1-.2 .2c-.1 .1-.1 .2-.2 .2 0 .1-.1 .2-.1 .3s-.1 .2-.1 .3v.3c0 .4.2 .8.4 1.1.3 .3.7 .4 1.1 .4s.8-.2 1.1-.4c.3-.3.4-.7.4-1.1 0-.1 0-.2 0-.3-.1-.2-.2-.2-.2-.3z"/>
        <path d="m25.4 33.8c0-.1-.1-.2-.1-.3s-.1-.2-.2-.2c-.4-.3-.9-.5-1.4-.4-.1 0-.2 .1-.3 .1s-.2 .1-.3 .1-.2 .1-.2 .2c-.3 .3-.4 .7-.4 1.1s.2 .8.4 1.1c.3 .3.7 .4 1.1 .4s.8-.2 1.1-.4c.3-.3.4-.7.4-1.1 0-.1 0-.2 0-.3-.1-.2-.1-.2-.1-.3z"/>
        <path d="m31.2 33.8c0-.1-.1-.2-.1-.3s-.1-.2-.2-.2c-.1-.1-.1-.1-.2-.2-.1 0-.2-.1-.3-.1s-.2-.1-.3-.1c-.2 0-.4 0-.6 0-.1 0-.2 .1-.3 .1s-.2 .1-.3 .1c-.1 .1-.2 .1-.2 .2-.3 .3-.4 .7-.4 1.1s.2 .8.4 1.1c.3 .3.7 .4 1.1 .4.2 0 .4 0 .6-.1s.3-.2.5-.3c.3-.3.4-.7.4-1.1 0-.1 0-.2 0-.3-.1-.2-.1-.2-.1-.3z"/>
        <path d="m19.6 39c0-.1-.1-.2-.1-.3-.1-.1-.1-.2-.2-.2-.3-.3-.9-.5-1.3-.4-.1 0-.2 0-.3 .1-.1 0-.2 .1-.3 .1-.1 .1-.2 .1-.2 .2s-.2 .2-.2 .3-.1 .2-.1 .3-.1 .2-.1 .3v.3c0 .4.2 .8.4 1.1.1 .1.3 .3.5 .3.2 .1.4 .1.6 .1.4 0 .8-.1 1.1-.4s.4-.7.4-1.1c0-.1 0-.2 0-.3-.1-.2-.2-.3-.2-.4z"/>
        <path d="m25.4 39c0-.1-.1-.2-.1-.3s-.1-.2-.2-.2-.2-.1-.2-.2c-.1 0-.2-.1-.3-.1s-.2-.1-.3-.1c-.2 0-.4 0-.6 0-.1 0-.2 0-.3 .1-.1 0-.2 .1-.3 .1-.1 .1-.2 .1-.2 .2-.3 .3-.4 .7-.4 1.1s.2 .8.4 1.1c.3 .3.7 .4 1.1 .4s.8-.1 1.1-.4c.1-.1.2-.3.3-.5s.1-.4.1-.6c0-.1 0-.2 0-.3-.1-.1-.1-.2-.1-.3z"/>
        <path d="m31.2 39c0-.1-.1-.2-.1-.3s-.1-.2-.2-.2c-.1-.1-.1-.1-.2-.2-.1 0-.2-.1-.3-.1s-.2-.1-.3-.1c-.2 0-.4 0-.6 0-.1 0-.2 0-.3 .1-.1 0-.2 .1-.3 .1-.1 .1-.2 .1-.2 .2-.3 .3-.4 .7-.4 1.1 0 .2 0 .4.1 .6s.2 .3.3 .5c.3 .3.7 .4 1.1 .4.2 0 .4 0 .6-.1s.3-.2.5-.3c.1-.1.3-.3.3-.5.1-.2.1-.4.1-.6 0-.1 0-.2 0-.3-.1-.1-.1-.2-.1-.3z"/>
      </g>
    </g>
  </svg>
      ...
      <g>
        <g>
          <path d="M499.639,396.039l-103.646-69.12c-13.153-8.701-30.784-5.838-40.508,6.579l-30.191,38.818
            ...
            c4.224-5.381,11.87-6.62,17.579-2.85l103.637,69.12C495.918,414.126,497.663,421.886,494.058,427.868z" fill="currentColor"/>
          <path d="M291.161,86.39c80.081,0.089,144.977,64.986,145.067,145.067c0,4.713,3.82,8.533,8.533,8.533s8.533-3.82,8.533-8.533
            c-0.099-89.503-72.63-162.035-162.133-162.133c-4.713,0-8.533,3.82-8.533,8.533S286.448,86.39,291.161,86.39z" fill="currentColor"/>
          <path d="M291.161,137.59c51.816,0.061,93.806,42.051,93.867,93.867c0,4.713,3.821,8.533,8.533,8.533
            c4.713,0,8.533-3.82,8.533-8.533c-0.071-61.238-49.696-110.863-110.933-110.933c-4.713,0-8.533,3.82-8.533,8.533
            S286.448,137.59,291.161,137.59z" fill="currentColor"/>
          <path d="M291.161,188.79c23.552,0.028,42.638,19.114,42.667,42.667c0,4.713,3.821,8.533,8.533,8.533s8.533-3.82,8.533-8.533
            c-0.038-32.974-26.759-59.696-59.733-59.733c-4.713,0-8.533,3.82-8.533,8.533S286.448,188.79,291.161,188.79z" fill="currentColor"/>
        </g>
      </g>
    </g>
  </svg>
...
<div class="flex items-start gap-2 mb-4">
  ...
  >
    <g transform="matrix(1,0,0,1,0,0)">
      <path d="m499.509 83.651-.006-.007-.012-.01a40.863 40.863 0 0 0 -28.6-11.583h-429.781a40.87 40.87 0 0 0 -28.367 11.36l-.014.013-.008.007-.005.005-.009.01a40.719 40.719 0 0 0 -12.707 29.712v285.685a41.136 41.136 0 0 0 41.11 41.11h429.779a41.135 41.135 0 0 0 41.111-41.11v-285.685a40.768 40.768 0 0 0 -12.491-29.507zm-170.6 172.073 162.318-150.58a21.813 21.813 0 0 1 1.508 8.014v285.685a21.8 21.8 0 0 1 -1.5 7.969zm141.98-164.417a21.924 21.924 0 0 1 6.025.849l-220.746 204.782-116.55-108.117-104.258-96.734a21.942 21.942 0 0 1 5.75-.78zm-450.133 315.506a21.837 21.837 0 0 1 -1.5-7.97v-285.685a21.808 21.808 0 0 1 1.6-8.251l105.662 98.033 56.732 52.627zm20.354 13.88a21.871 21.871 0 0 1 -6.07-.862l162.369-151.131 52.21 48.433a9.632 9.632 0 0 0 13.1 0l52.038-48.275 162.2 150.974a21.91 21.91 0 0 1 -6.071.861z" fill="currentColor"/>
    </g>
  </svg>
