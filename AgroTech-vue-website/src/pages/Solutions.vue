  ...
  <div>
    <div class="relative overflow-hidden h-[400px] sm:h-[500px] md:h-[580px]">
      ...
      <img
        ...
        class="absolute top-0 left-0 w-full h-full object-cover brightness-[0.56] z-0"
        alt=""
      />
    ...
    <!--Flex-heading-->
    <section
      class="max-w-[1440px] mx-auto py-10 sm:py-12 font-montserrat px-4 sm:px-6 lg:px-8 border-b-2 border-b-gray-100 lg:pt-28"
    >
      <div
      ...
      >
        ...
        <div>
          <h1
            class="text-xl sm:text-2xl lg:text-4xl max-w-[90%] sm:max-w-[700px] font-semibold"
          >
            Explore how our integrated solutions help farms and food systems
            thrive.
          </h1>
        </div>
      </div>
...
<!-- Solutions Section -->
<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-16 font-montserrat">
  <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-2">

    <!-- Card -->
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-crops.jpg" 
      ...
      <div class="p-4">
        <h3 class="text-xl font-semibold text-gray-900 transition-colors duration-300 group-hover:text-green-700">
          Precision farming
        </h3>
    ...
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-irrigation.jpg" 
    ...
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-pic9.jpg" 
    ...
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-pic1.jpg" 
           alt="Climate Resilient Program" 
           class="object-cover w-full h-56 transition-transform duration-500 transform md:h-64 lg:w-44 lg:h-32 group-hover:scale-105">
      <div class="p-4">
        <h3 class="text-xl font-semibold text-gray-900 transition-colors duration-300 group-hover:text-green-700">
          Climate-Resilient program
    ...
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-pic6.jpg" 
           alt="Technology Integration" 
           class="object-cover w-full h-56 transition-transform duration-500 transform md:h-64 lg:w-44 lg:h-34 group-hover:scale-105">
      <div class="p-4">
        <h3 class="text-xl font-semibold text-gray-900 transition-colors duration-300 group-hover:text-green-700">
          Technology integration
        </h3>
        <p class="mt-2 text-sm leading-relaxed text-gray-600">
          We bring cutting-edge technology into the heart of agriculture — making operations smarter, faster, and more resilient from field to market.
        </p>
      </div>
    </div>
    ...
    <!-- Organic Practices -->
    <div class="flex flex-col items-start overflow-hidden transition-shadow duration-300 bg-white shadow-md lg:flex-row lg:space-x-6 rounded-2xl hover:shadow-xl group">
      <img src="/src/assets/img/farm-pic3.jpg" 
      ...
      <div class="p-4">
        ...
        <p class="mt-2 text-sm leading-relaxed text-gray-600">
          Our organic practices prioritize soil vitality, natural inputs, and ecological harmony to produce high-quality crops without synthetic chemicals or GMOs.
        </p>
      </div>
    </div>
...
<section class="max-w-[1440px] mx-auto py-20 font-montserrat px-4 sm:px-6 lg:px-8">
  <div class="mx-2">
    <div class="relative">
      <img
